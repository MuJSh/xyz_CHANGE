...
(function () {
  ...
  const detailContent = {
    ...
    '2024-11-20-new-paper-from-our-group': '<p>Congratulations to Dr. Na Zhao on publishing a new paper in <em>Frontiers of Environmental Science &amp; Engineering</em>.</p><p>The paper, titled <em>Nonlinear relationship between air pollution and precursor emissions in Qingdao, eastern China</em>, used a three-dimensional atmospheric chemistry model to investigate how emission reductions from different sectors and different NO<sub>x</sub> and NMVOC reduction ratios affect major air pollutants in Qingdao, including fine particulate matter and ozone.</p><p>Zhao, N., Zhang, Y., and Xue, L. (2025). Nonlinear relationship between air pollution and precursor emissions in Qingdao, eastern China. <em>Frontiers of Environmental Science and Engineering</em>, 19(1), 1–12.</p><p><strong>Abstract:</strong> Exploring the nonlinear relationship between air pollution and precursor emissions in Qingdao, eastern China is crucial for improving air quality. The study simulated 32 emission reduction scenarios based on different VOC and NO<sub>x</sub> emission reduction ratios using the WRF-CAMx model. VOC emission reductions were beneficial for reducing PM<sub>2.5</sub> in January and O<sub>3</sub> in June. However, when VOCs were not reduced, NO<sub>x</sub> had to be reduced by at least 48% and 70% to decrease PM<sub>2.5</sub> and O<sub>3</sub>, respectively. The study further evaluated responses to emission reductions from different sources and analyzed coordinated NO<sub>x</sub> and VOC reduction pathways for combined PM<sub>2.5</sub> and O<sub>3</sub> pollution. The results suggest that a collaborative optimization pathway should prioritize VOC control first, while further control of combined pollution depends on deep NO<sub>x</sub> reductions.</p><p><a href="https://doi.org/10.1007/s11783-025-1929-3">Read the paper</a></p>'
  };
